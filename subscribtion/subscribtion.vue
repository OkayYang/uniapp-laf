	...
	<view class="" v-show="!button_show" style="width:100%;height:1100rpx;position:relative;">
		...
		<view class=""
			...
			<view style="display:flex;align-items:center;width:100%;margin-bottom:20rpx 0;"
				...
				<image src="../../static/subscribtion/删除.png" mode="aspectFit"
			...
			<view @click='addInput' style="display:flex;align-items:center;height:30rpx;margin-top:20rpx;">
				<image src="../../static/subscribtion/增加.png" mode="aspectFit"
		...
		<!-- 使用帮助 -->
		<view class="" style="display:flex;align-items:center;position:relative;width:83%;height:12%;font-size:35rpx;color:grey;margin:auto" @click="openHelp">
			<image src="../../static/subscribtion/问题.png"  mode="aspectFit"
					style="display:inline;width:50rpx;padding-right:20rpx;"></image>使用帮助
		</view>
		...
		<u-popup :show="totalTip" @close="close_total" mode="center" round=20 closeable=true>
			<view style="width: 600rpx;height: 300rpx;position:relative;display:flex;justify-content:center">
				...
				<view style="position:absolute;top:190rpx;border:1rpx solid rgba(0, 0, 0, 0.1);width:200rpx;height:70rpx;border-radius:30rpx;text-align:center;line-height:70rpx;background-color: rgba(170, 170, 255, 0.1);" @click="jumpMySub">管理推送</view>
			</view>
		</u-popup>
...
<script>
	...
	export default {
		...
		onShow() {
			if(this.data_formInput.title>40){
				this.closable=false
			}
		},
		methods: {
